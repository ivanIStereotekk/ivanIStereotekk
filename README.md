...
**Я Иван Гончаров**  ✨ бекенд ✨ разработчик. 
...
> [!NOTE]
> Некоторые проекты или их версии скрыты так как являются собственностью компаний в которых я работал,
> несомненно являются хорошим показателем практики и опыта за период моей работы.
